...
<div id="boardDetailMain">
	<table class="mt-5 py-5 justify-content-center" id="notiMain">
		<tr id="contentHead">
			<th class="col-4 py-3 px-5">${photo.nickname}</th>
            ...
            <tr>
                <td class="py-3 my-2">
                    ...
                    <c:if test="${sessionScope.member.id eq reply.id || sessionScope.member.id eq 'adminadmin'}">
                        <form action='<%=request.getContextPath()%>/photoComment/delete' method="get" class="mt-2 mx-5" style="display: inline-block;">
...
건전한 커뮤니티를 위해 자제를 당부 드립니다."
	...
	<div class="row mb-5 mt-3">
		...
		<div class="col-3">
			<div class="row w-50">
				<c:if
					test="${sessionScope.member.id == photo.id || sessionScope.member.id eq 'adminadmin'}">
		...
		<div class="col-4">
			<a href="<%=request.getContextPath()%>/photo/list" id="goBoardList"
